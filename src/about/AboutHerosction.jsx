...
const AboutHerosction = () => {
  return (
    <section className="w-full bg-black px-4 md:px-8 lg:px-12 py-16">
      {/* Heading */}
      <h1
      ...
      {/* Grid Section */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-8 text-white font-[Poppins]">
        {/* Left Block */}
        <div className="flex-1 group">
          ...
          >
            ...
            markets, empowering traders with cutting-edge insights and AI-driven
        ...
        <div className="flex-[1.5] group">
          <img
            src={About2}
            alt="Gold chart"
            className="w-full h-[360px] object-cover rounded-2xl transform transition-transform duration-500 group-hover:scale-105"
          />
        </div>
        ...
        <div className="flex-1 group flex flex-col justify-between">
          ...
          >
            ...
            expertise, innovation, and dedication to help traders at all levels
            succeed in the forex world. Join us and take your trading journey to
            the next level.
          </p>
          <img
            src={About3}
