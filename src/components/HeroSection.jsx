...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-screen pt-24 overflow-hidden">
      ...
      <button className="rounded-full border-2 border-yellow-500 bg-yellow-500 px-6 py-2 text-sm font-black tracking-[0.05em] text-black transition-all duration-300 w-full h-full group-hover:bg-black group-hover:text-white hover:border-2 hover:border-yellow-800">
        START FREE TRIAL
      </button>
      </div>
