...
export default function CustomerDashboard() {
  return (
    <div
      className="h-full group flex flex-col md:flex-row items-center justify-between gap-6 px-4 sm:px-6 md:px-12 lg:px-20 py-10 border border-gray-900 rounded-3xl transition-all duration-500 hover:border-yellow-500 max-w-[95vw] md:max-w-[1300px] mx-auto"
      style={{
    ...
    >
      ...
      <div className="w-full md:w-[60%] text-center md:text-left">
        ...
        <p className="text-sm md:text-base mt-4 text-white leading-relaxed">
          ...
          BY CUTTING-EDGE AI, EXPERT ANALYSIS, AND MARKET PRECISION, OUR
          SIGNALS TURN UNCERTAINTY INTO CALCULATED SUCCESS.
        </p>
