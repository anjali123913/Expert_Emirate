...
export default function CustomerDashboard() {
  return (
  <div
      className="group w-full sm:w-[550px] md:w-[550px] lg:w-2/3 flex flex-col md:flex-row items-center justify-between gap-8 px-4 py-6 md:px-5 md:py-6 border border-gray-900 border-l-gray-800 border-t-gray-800 border-b-gray-800 rounded-3xl transition-all duration-500 relative hover:border-t-yellow-600 hover:border-l-yellow-700 hover:border-b-yellow-600 hover:border-r-yellow-700"
      style={{
        background:
    ...
    >
      ...
      <div className="w-full  lg:w-2/3">
        ...
        {/* BUTTONS */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-start gap-4 sm:gap-6 mt-6">
