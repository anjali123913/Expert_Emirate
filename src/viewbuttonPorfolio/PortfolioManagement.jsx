...
const PortfolioManagement = () => {
  return (
    <section className="w-full bg-black text-white px-4 sm:px-6 lg:px-20 py-20 font-[Poppins]">
      <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row items-start justify-between gap-16">
        
        {/* Left Text Section */}
        <div className="w-full md:w-1/2 space-y-8">
          {/* Heading */}
          <h2 className="text-[22px] sm:text-[26px] md:text-[30px] lg:text-[36px] font-semibold leading-snug">
            Invest in
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-yellow-700 via-yellow-300 to-yellow-700 font-bold">
              Portfolio Management
            </span>
          </h2>

          {/* Description */}
          <p className="text-[#b3b3b3] text-[14px] sm:text-[15px] md:text-[16px] leading-loose">
