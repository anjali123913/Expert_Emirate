    ...
    return (
      <section className="bg-[#111111] text-white px-4 py-11 rounded-3xl max-w-4xl mx-auto border shadow-lg shadow-gray-900 border-gray-600">
        ...
        <h2 className="text-center text-2xl sm:text-3xl md:text-4xl font-bold text-yellow-400 mb-4">
          Celebrating Excellence with 70+ <br className="hidden sm:block" /> Industry Awards
        </h2>
  
        {/* Description */}
        <p className="text-center text-gray-300 max-w-3xl mx-auto text-base sm:text-lg mb-10">
          Our dedication to providing world-class trading services has been recognized globally. Over
          the years, we’ve earned more than 70 prestigious awards, solidifying our position as a leader
          in the financial industry.
        </p>
  
        {/* Award Highlights */}
        <div className="bg-[#1A1A2F] rounded-2xl p-6 space-y-4 mb-10">
          {/* Award 1 */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-[#2A2A3F] rounded-xl px-4 py-3">
        ...
        <p className="text-center text-gray-400 text-sm sm:text-base max-w-2xl mx-auto mb-8">
          These accolades reflect our unwavering focus on innovation, trust, and client satisfaction.
          With every award, we reaffirm our promise to deliver unparalleled trading experiences.
        </p>
