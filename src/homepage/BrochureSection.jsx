...
const BrochureSection = () => {
  return (
    <div className="w-full bg-[#0F0F13]  px-4 sm:px-6 lg:px-10 relative overflow-hidden">
      ...
      <div
        className=" border-[1px]  w-full max-w-[1300px] mx-auto rounded-[30px] px-10 lg:px-10 flex flex-col lg:flex-row items-center justify-between gap-10 
        border-transparent 
        bg-gradient-to-br from-[#1A1A1F] to-[#0F0F13] 
        hover:shadow-xl hover:shadow-[#FFD966]/10 
        transition-all duration-500 
        group-hover:border-[#e9832a]"
      >
        {/* Text Section */}
        <div className="flex-1 flex flex-col gap-8 text-center lg:text-left">
          ...
          <button className="max-w-[220px] bg-gradient-to-l from-[#452e06] via-[#d1bf5a] via-50% to-[#452e06] text-black rounded-full px-6 py-3 text-lg font-poppins font-bold shadow-lg hover:scale-105 transition-all duration-300 animate-fadeIn delay-300 group-hover:bg-[#000] relative overflow-hidden">
            <span className="relative z-10 flex items-center justify-center gap-2 tracking-wider leading-3">
              Download Now
        ...
        {/* Image Section */}
        <div className="flex-1 w-full max-w-[700px] lg:max-w-none animate-fadeInRight">
          <div className="relative">
            <img
              src={brochureImage}
              alt="Brochure"
              className="w-full h-auto object-contain transform transition-all duration-500 group-hover:scale-110"
            />
